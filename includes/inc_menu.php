 ...
 <div class="container">
        <div class="row row-content">
          ...
          <div class="tab-content">
               ...
               <ul class="media-list tab-pane fade in active">
                ...
                <li class="media" id="shopping-cart" ng-repeat="dish in menuCtrl.dishes | filter:menuCtrl.filtText">
        ...
        <ol class="ui-list shopping-cart--list" id="shopping-cart--list">  
          ...
          <div class="_column product-info">
            <h5 class="product-name">{{dish.name}} <label class="dishPrice">,  {{dish.price}}</label></h5>
             <!-- <div class="price product-single-price">${{dish.price}}</div>-->
            <p class="product-desc">{{dish.description}}</p>
            
          </div>
          <div class="_column product-modifiers" data-product-price="{{dish.price}}">
            <div class="_grid">
