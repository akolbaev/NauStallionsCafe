    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <ul class="nav navbar-nav">
                     <li class="active"><a href = "index.php?page=home_page"><span class="glyphicon glyphicon-home"
                   ...
                   <!-- <li class="dropdown">
                    ...
                    <li><a href="index.php?page=bulletin_board"><i class="fa fa-newspaper-o "></i> Stallion  Classifieds</a></li>
            ...
            <div class="modal-body">
                <form class="form-inline"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control input-sm" id="passwor" placeholder="password">
                    </div>
                    <div class="checkbox">
                        <label>
